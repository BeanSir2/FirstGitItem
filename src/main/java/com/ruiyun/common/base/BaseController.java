...
import com.ruiyun.shiro.ShiroUtil;
...
public class BaseController extends Base {
	...
	protected Map<String, Object> getParamsAndUser(HttpServletRequest request) {
		...
		SystemOperatorEntity ose = ShiroUtil.getOperatorInfo();
		params.put("modifyOperatorId", ose.getOperatorId());
		params.put("modifyOperatorName", ose.getOperatorName());
